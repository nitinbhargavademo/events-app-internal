...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'somewhere coool' },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'someplace cooler' }
    ]
};
